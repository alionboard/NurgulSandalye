        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LongAdress = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    District = table.Column<string>(type: "nvarchar(180)", maxLength: 180, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PictureUris", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PictureUris_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PictureUris_Products_ProductId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PictureUris_ProductId",
                table: "PictureUris",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_PictureUris_ProductId1",
                table: "PictureUris",
                column: "ProductId1");
